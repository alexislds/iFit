    ...
    <form action="./perfil" method="post" class="perfil-form">
        <div class="perfil-lista">
            ...
            ?>
                    ...
                    <input required  class='perfil-lista-input' name='perfilEmail' type='text' placeholder='Seu email:' value='<?php echo $email; ?>'>
                    </div>

                    <div class='perfil-lista-item' >
                    <label class='perfil-lista-label'>Sua senha:</label>
                    <input required class='perfil-lista-input perfilJs' name='perfilSenha' type='text' placeholder='Sua senha:'  value='<?php echo $senha; ?>'>
                    </div>

                    <div class='perfil-lista-item'>
                    <label class='perfil-lista-label'>Seu nome:</label>
                    <input required class='perfil-lista-input perfilJs' name='perfilNome' type='text' placeholder='Seu nome:'  value='<?php echo $nome; ?>'>
                    </div>

                    <div class='perfil-lista-item'>
                    <label class='perfil-lista-label'>Sua academia:</label>
                    <input required class='perfil-lista-input perfilJs' name='perfilAcademia' type='text' placeholder='Sua academia'  value='<?php echo $academia; ?>'>
                    </div>

                    <div class='perfil-lista-item'>
                    <label class='perfil-lista-label'>Sexo:</label>
                    <input class='perfil-lista-input perfilJs' name='perfilSexo' type='text' placeholder='Seu sexo'  value='<?php echo $sexo; ?>'>
                    </div>

                    <div class='perfil-lista-item'>
                    <label class='perfil-lista-label'>Sua idade:</label>
                    <input class='perfil-lista-input perfilJs' name='perfilIdade' type='text' placeholder='Sua idade'  value='<?php echo $idade; ?>'>
                    </div>
            <?php 
            }
            else{
