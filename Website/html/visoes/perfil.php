    ...
    <form action="./perfil" method="post" class="perfil-form">
        <div class="perfil-lista">
            ...
            ?>
                    ...
                    <input required  class='perfil-lista-input' name='perfilEmail' type='text' placeholder='Seu email:' value='<?php echo $email; ?>' disabled>
                    </div>

                    <div class='perfil-lista-item' >
                    <label class='perfil-lista-label'>Sua senha:</label>
                    <input required class='perfil-lista-input perfilJs' name='perfilSenha' type='text' placeholder='Sua senha:'  value='<?php echo $senha; ?>' disabled>
                    </div>

                    <div class='perfil-lista-item'>
                    <label class='perfil-lista-label'>Seu nome:</label>
                    <input required class='perfil-lista-input perfilJs' name='perfilNome' type='text' placeholder='Seu nome:'  value='<?php echo $nome; ?>' disabled>
                    </div>

                    <div class='perfil-lista-item'>
                    <label class='perfil-lista-label'>Sua academia:</label>
                    <input required class='perfil-lista-input perfilJs' name='perfilAcademia' type='text' placeholder='Sua academia'  value='<?php echo $academia; ?>' disabled>
                    </div>
