<section class="solicitacao-ficha">
    ...
    <div class="solicitacao-ficha-especificacoes">
        ...
        <form action="#" method="post" class="solicitacao-ficha-especificacoes-form">
            <div class="solicitacao-ficha-especificacoes-lista">
                <input class="solicitacao-ficha-especificacoes-lista-input" type="text" placeholder="teste">
                <input class="solicitacao-ficha-especificacoes-lista-input" type="text" placeholder="teste">
                <input class="solicitacao-ficha-especificacoes-lista-input" type="text" placeholder="teste">
                <input class="solicitacao-ficha-especificacoes-lista-input" type="text" placeholder="teste">
                <input class="solicitacao-ficha-especificacoes-lista-input" type="text" placeholder="teste">
    ...
    <div class="solicitacao-ficha-dados">
        ...
        <form action="#" method="post" class="solicitacao-ficha-dados-form">
            <div class="solicitacao-ficha-dados-lista">
                <input class="solicitacao-ficha-dados-lista-input" type="text" placeholder="teste">
                <input class="solicitacao-ficha-dados-lista-input" type="text" placeholder="teste">
            </div>
        </form>
    </div>
