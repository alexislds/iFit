        ...
        <div class="solicitacao-ficha-especificacoes">
            ...
            <div class="solicitacao-ficha-especificacoes-lista">
               <div class="solicitacao-ficha-especificacoes-lista-item">
                  ...
                  <input  disabled class="solicitacao-ficha-especificacoes-lista-input" type="text" placeholder="A quanto tempo treina?"  value="<?php echo $tempo ?> ">
               </div>  
                <div class="solicitacao-ficha-especificacoes-lista-item">
                     <label class="solicitacao-ficha-especificacoes-lista-label">Qual meu foco</label>
                 <input  disabled class="solicitacao-ficha-especificacoes-lista-input" type="text" placeholder="Qual meu foco" value="<?php echo $foco ?>">
                </div> 
                <div class="solicitacao-ficha-especificacoes-lista-item">
                     <label class="solicitacao-ficha-especificacoes-lista-label">Altura</label>
                  <input  disabled class="solicitacao-ficha-especificacoes-lista-input" type="text" placeholder="Altura" value="<?php echo $altura ?>">
                </div> 
                <div class="solicitacao-ficha-especificacoes-lista-item">
                    <label class="solicitacao-ficha-especificacoes-lista-label">Peso</label>
                 <input  disabled class="solicitacao-ficha-especificacoes-lista-input" type="text" placeholder="Peso" value="<?php echo $peso ?>">
                </div> 

                <div class="solicitacao-ficha-especificacoes-lista-item">
                 <label class="solicitacao-ficha-especificacoes-lista-label">Problemas de saude,se sim qual?</label>
                 <input  disabled class="solicitacao-ficha-especificacoes-lista-input" type="text" placeholder="Problemas de saude,se sim qual?" value="<?php echo $saude ?>">
                </div>

                <div class="solicitacao-ficha-especificacoes-lista-item">
                  <label class="solicitacao-ficha-especificacoes-lista-label">Possui ou teve lesões,se sim qual?</label>
                 <input  disabled class="solicitacao-ficha-especificacoes-lista-input" type="text" placeholder="Possui ou teve lesões,se sim qual?" value="<?php echo $lesoes ?>">
                </div>
               <div class="solicitacao-ficha-especificacoes-lista-item">
                  <label class="solicitacao-ficha-especificacoes-lista-label">Pratica ou praticou algum esporte,se sim qual?</label>
                 <input  disabled class="solicitacao-ficha-especificacoes-lista-input" type="text" placeholder="Pratica ou praticou algum esporte,se sim qual?" value="<?php echo $pratica ?>">
               </div> 
            </div>
        </div>
        <div class="solicitacao-ficha-dados">
            ...
            <div class="solicitacao-ficha-dados-lista">
              <div class="solicitacao-ficha-dados-lista-item">
                 ...
                 <input  disabled class="solicitacao-ficha-dados-lista-input" type="text" name="fichaTipo" placeholder="Tipo de treino" value="<?php echo $tipo ?>">
               </div>
               <div class="solicitacao-ficha-dados-lista-item">
                    <label class="solicitacao-ficha-dados-lista-label">Descrição</label>
                 <textarea  disabled class="solicitacao-ficha-dados-lista-textarea" type="text" placeholder=">Descrição"><?php echo $descricao ?></textarea>
               </div> 
            </div>
        </div>
